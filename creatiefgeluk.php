      ...
      <article class="geluk-page container">
        ...
        <div class="coach-content auto-grid">
          ...
          <div class="auto-grid-item-span">
            <img src="assets/img/creatiefGelukBanner.png" alt="A banner with images of art supplies" class="article-img">
          </div>
          ...
          <div class="auto-grid-item">
            <p class="c-larger-p">Een waardevolle sessie</p>
            <p>
              Waarom deze sessie bijzonder, waardevol en zeker aan te raden is?
              <br>

              Je krijgt namelijk on-the-spot-coaching, ontdekt wat er speelt in je onbewuste. Alle materialen worden verzorgd en je leert ook nog eens leuke technieken. 
              Uiteraard neem je je kunstwerk gewoon mee naar huis. Of ga je er thuis mee verder.
            </p>
            <p>
