...
session_start();
file_put_contents('debugMail.log', 'kerntest Email scriptt started' . PHP_EOL, FILE_APPEND);
...
file_put_contents('debugMail.log', '$_POST contents: ' . print_r($_POST, true) . PHP_EOL, FILE_APPEND);

if (isset($_POST['name'], $_POST['email'], $_POST['g-recaptcha-response'])) {
    $errors = [];
    file_put_contents('debugMail.log', 'Inside if statement' . PHP_EOL, FILE_APPEND);
    $extra = [];


    if (isset($_POST['telefoonnummer'])) {
        $extra['telefoonnummer'] = $_POST['tel'];
    }
