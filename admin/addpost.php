...
if (isset($_POST['create_post'])) {
  ...
  //todo 1 user ???
  $sabine = "Sabine";
  $query = "INSERT INTO posts(post_cat_id, post_title, post_slug, post_author, post_date,post_image,post_thumb ,post_intro,post_content,post_url,post_tags,post_status) ";
  $query .= "VALUES(? , ? , ? , ? , now() , ? , ? , ? ,? , ? , ? , ?) ";
  ...
  $stmt->bindParam(6, $post_thumbnail, PDO::PARAM_STR);
  ...
  $stmt->bindParam(10, $post_tags, PDO::PARAM_STR);
  $stmt->bindParam(11, $post_status, PDO::PARAM_STR);
  $stmt->execute();
...
<div class="rj-modal">
  ...
  if ($post_status == 'published') {
    ...
    echo '
    <p>
    <a href="' . $root_url . '/blogpost/' . $slug . '">View Post on site</a>
    </p>
    ';
  };
  echo '
